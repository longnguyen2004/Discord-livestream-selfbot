...
type PathSource = {
    type: "hlsSource" | "redirect" | "rpiCameraSource" | "rtmpConn" | "rtmpSource" | "rtspSession" | "rtspSource" | "rtspsSession" | "srtConn" | "srtSource" | "udpSource" | "webRTCSession" | "webRTCSource"
    id: string
}
...
export default {
    ...
    register(bot) {
        ...
        return [
            createCommand(
                new Command("mtx-list")
                    .description("List currently active MediaMTX streams"),
                async (message) => {
                    ...
                    const createMessageContent = (paths: PathsListResponse, currentPage: number) =>
                    {
                        let message = "";
                    ...
                    attachReactionButtons(reply, new Map([
                        ["◀️", async () => {
